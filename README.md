...
#
Folder Structure og this project
├── Assets
...
├── frontend
    ...
    │   │   │   ├── link.svg
    │   │   │   ├── moon.svg
    │   │   │   ├── navigate-back-black.svg
    │   │   │   ├── navigate-back-white.svg
    │   │   │   └── sun.svg
    │   │   └── wanderlustbg.webp
    │   ├── components
    │   │   ├── blog-feed.tsx
    ...
    │   │   ├── scroll-to-top.tsx
    │   │   ├── skeletons
    │   │   │   ├── featured-post-card-skeleton.tsx
    │   │   │   ├── latest-post-card-skeleton.tsx
...
├── kubernetes
    ...
    │   ├── all-deps.png
    │   ├── app.png
    │   ├── backend.env.docker.png
    │   ├── backend.png
    │   ├── context wanderlust.png
    │   ├── docker backend build.png
    │   ├── docker frontend build.png
    │   ├── docker images.png
    │   ├── docker login.png
    │   ├── edit-coredns.png
    │   ├── frontend.env.docker.png
    │   ├── frontend.png
    │   ├── get-coredns.png
    │   ├── mongo.png
